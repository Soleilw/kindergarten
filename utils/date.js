...
module.exports = {
  getdateTime: Lunar.getdateTime,
  toLunar: Lunar.toLunar
}
...
var Lunar = {
  ...
  chineseNumber: function (num) {
    var dateHash = ['', '一', '二', '三', '四', '五', '六', '七', '八', '九', '十'], res;
    if (num <= 10) {
      res = '初' + dateHash[num];
  ...
  getdateTime: function (strings) {
    ...
    let d = new Array(
      ...
      "星期五",
      "星期六");
    let dt = today.getFullYear() + "年" + today.getMonth() + 1 + "月" + today.getDate() + "日 " + d[today.getDay()]
    return dt;
  },
  //转换公历
  //@param year 阴历-年
